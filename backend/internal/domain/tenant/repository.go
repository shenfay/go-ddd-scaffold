...
type TenantRepository interface {
	...
	// 分页查询
	FindAll(ctx context.Context, pagination ddd.Pagination) (*ddd.PaginatedResult[*Tenant], error)
	FindByCriteria(ctx context.Context, criteria TenantSearchCriteria, pagination ddd.Pagination) (*ddd.PaginatedResult[*Tenant], error)
...
type TenantReadModel interface {
	...
	ListTenants(ctx context.Context, criteria TenantListCriteria, pagination ddd.Pagination) (*ddd.PaginatedResult[*TenantListItemDTO], error)
	SearchTenants(ctx context.Context, keyword string, pagination ddd.Pagination) (*ddd.PaginatedResult[*TenantListItemDTO], error)
