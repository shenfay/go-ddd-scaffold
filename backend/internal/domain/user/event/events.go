...
func NewUserRegisteredEvent(userID model.UserID, username, email string) *UserRegisteredEvent {
...
func NewUserActivatedEvent(userID model.UserID) *UserActivatedEvent {
...
func NewUserDeactivatedEvent(userID model.UserID, reason string) *UserDeactivatedEvent {
...
func NewUserLoggedInEvent(userID model.UserID, ipAddress, userAgent string) *UserLoggedInEvent {
...
func NewUserPasswordChangedEvent(userID model.UserID, ipAddress string) *UserPasswordChangedEvent {
...
func NewUserProfileUpdatedEvent(userID model.UserID, updatedFields []string) *UserProfileUpdatedEvent {
...
func NewUserEmailChangedEvent(userID model.UserID, oldEmail, newEmail string) *UserEmailChangedEvent {
...
func NewUserLockedEvent(userID model.UserID, reason string, lockedUntil time.Time) *UserLockedEvent {
...
func NewUserUnlockedEvent(userID model.UserID) *UserUnlockedEvent {
...
func NewUserFailedLoginAttemptEvent(userID model.UserID, ipAddress, userAgent, reason string) *UserFailedLoginAttemptEvent {
