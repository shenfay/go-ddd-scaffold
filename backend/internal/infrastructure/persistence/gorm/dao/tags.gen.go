...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.NameKey = field.NewString(tableName, "name_key")
	_tag.DescriptionKey = field.NewString(tableName, "description_key")
	_tag.Category = field.NewString(tableName, "category")
	_tag.IsActive = field.NewBool(tableName, "is_active")
	_tag.Metadata = field.NewString(tableName, "metadata")
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.NameKey = field.NewString(table, "name_key")
	t.DescriptionKey = field.NewString(table, "description_key")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["id"] = t.ID
	t.fieldMap["name_key"] = t.NameKey
	t.fieldMap["description_key"] = t.DescriptionKey
